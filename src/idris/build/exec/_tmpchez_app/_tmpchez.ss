...
;; @generated by Idris 0.6.0-86c53e607, Chez backend
(import (chezscheme))
(case (machine-type)
...
(load-shared-object "lib_bits_vec.so")
...
(define BitsVec-prim__bv_print (lambda (farg-0 farg-1 farg-2) ((foreign-procedure "bv_print" (unsigned-8 unsigned-64) void) farg-0 farg-1)))
(define u--prim__sub_Integer (lambda (arg-0 arg-1) (- arg-0 arg-1)))
(define BitsVec-bv_print (lambda (arg-0 ext-0) (let ((e-0 (car arg-0))) (let ((e-1 (cdr arg-0))) (BitsVec-prim__bv_print e-0 e-1 ext-0)))))
...
(PrimIO-unsafePerformIO (lambda (eta-0) (BitsVec-bv_print (cons 8 26) eta-0)))
  (collect 4)
